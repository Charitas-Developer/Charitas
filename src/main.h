...
inline int64_t PastDrift(int64_t nTime)   { return nTime - 60; } // up to 60 seconds from the past
inline int64_t FutureDrift(int64_t nTime) { return nTime + 60; } // up to 60 seconds from the future
