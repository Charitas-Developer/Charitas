Charitas-qt: Qt5 GUI for Charitas
===============================
...
A warning for people using the *static binary* version of Charitas on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of Charitas is linked against libdb 5.0 (see also `this Debian issue`_).
